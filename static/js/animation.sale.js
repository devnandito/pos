...
$("#newMethodPay").change(function () {
  ...
  if (method == "efectivo") {
    ...
    <div class="col-xs-4">
      <div class="input-group">
        <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
        <input type="text" class="form-control newValueMoney" name="newValueMoney" placeholder="00000" required>
      </div>
    </div>
    <div class="col-xs-4 catchChangeMoney" style="padding-left: 0px;">
      <div class="input-group">
        <span class="input-group-addon"><i class="ion ion-social-usd"></i></span>
        <input type="text" class="form-control newChangeMoney" name="newChangeMoney" placeholder="00000" readonly>
      </div>
    </div>
    `);
